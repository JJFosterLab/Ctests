                   ...
                   ...) #passed to lines
{
  ...
  dd = dmixedvonmises(x = circular(xx,
                      ...
                      mu1 = mu1,
                      kappa1 = kappa1,
                      prop = if(is.na(mu2)){1.0}else{prop},
                      mu2 = if(is.na(mu2)){0.0}else{mu2},
...
# Fit maximum likelihood biomodal model -----------------------------------
cmle = circ_mle(data = all_angles)
...
best_model = with(cmle,
                  {
                    ...
                    bm = results[mod_names%in% bestmodel, ]
                    return(bm)
                    }
                  )
